...
class PinocchioInterface:
    def __init__(self, urdf_file, EE_name, n_joint, contorl_frequency=0.5):
        self.urdf_file_path = urdf_file
        self.end_effector_name = EE_name
    ...
    def Diff(self, x_):
        ...
        self.D_x = x_
        xdot=(3*self.D_x-4*self.D_xold+self.D_xold2)*0.5*self.contorl_frequency
    ...
    def GetEERot(self):
        return self.end_effector_rotation

    def GetJacobian(self):
        return self.Linear_Jacobian_M, self.Angular_Jacobian_M, self.J_Matrix
    ...
    def GetEEVel(self):
        return self.end_effector_linear_velocity
    
    def GetEEangVel(self):
        return self.end_effector_angular_velocity